...
CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('CheckOne')
...
CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('CheckTwo')

WebUI.click(findTestObject('Object Repository/WEB/Page_Applitools/a_diff2'))

WebUI.click(findTestObject('Object Repository/WEB/Page_Applitools/button_Click me'))

CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('CheckThree')
