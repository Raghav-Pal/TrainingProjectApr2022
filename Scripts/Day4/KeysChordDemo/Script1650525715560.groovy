...
WebUI.click(findTestObject('Object Repository/Page_Automation testing - Google Search/span_Increase Innovation And Speed With End_1dc262'))

WebUI.doubleClick(findTestObject('Object Repository/Page_Automation testing - Google Search/span_Increase Innovation And Speed With End_1dc262'))
